            ...
            <li key={item.id} className="py-3 sm:py-4">
              <div className="flex items-start">
                ...
                <div className="flex flex-col justify-around px-4">
                  <div className="inline-flex items-center text-base pb-2 text-gray-900 dark:text-white">
                    <a
                  ...
                  <div className={"flex flex-row "}>
                    <button
                      ...
                      className={
                        "h-8 w-8 text-black mr-2 flex flex-col justify-center items-center"
                      }
                    ...
                    <button
                      ...
                      className={
                        "h-8 w-8  flex flex-col justify-center items-center"
                      }
